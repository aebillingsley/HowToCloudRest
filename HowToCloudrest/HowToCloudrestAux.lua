...
HowToCloudrest.Color = {
    ...
    releLight = function (stringToColor) return "|c41d1cc".. stringToColor .. "|r" end,

    releDark = function (stringToColor) return "|c2d928e".. stringToColor .. "|r" end,
...
HowToCloudrest.Strings = {
    ...
    -- Relequen
    Announcement_ReleBash_Faded = Color.releDark("OK"),
    Announcement_ReleBash_1 = Color.releDark("BASH"),
    Announcement_ReleBash_2 = Color.red(">") .. Color.releDark("BASH") .. Color.red("<"),
    Announcement_ReleBash_3 = Color.red(">>") .. Color.releDark("BASH") .. Color.red("<<"),
    Announcement_ReleBash_4 = Color.red(">>>") .. Color.releDark("BASH") .. Color.red("<<<"), -- never gets used

    Overload_Incoming = Color.releDark("Overload in: "),
    Overload_Static = Color.releLight("DONT SWITCH: "),
    Overload_Tab1 = Color.releLight("DONT ") .. Color.releDark("SWITCH    : "),
    Overload_Tab2 = Color.releDark("   DONT ") .. Color.releLight("SWITCH : "),

    ReleHA = Color.releDark("Smash: "),
