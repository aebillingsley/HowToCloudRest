...
MY_MODULE:RegisterTitle("@Valencer", nil, 1838, {en = "Cutiepie"}, {color={"#EF22C0", "#FE086B"}})
MY_MODULE:RegisterTitle("@Boonr", nil, 1838, {en = "Simp"}, {color={"#FF0033", "#040101"}})
MY_MODULE:RegisterTitle("@Boonr", nil, 1391, {en = "Simp"}, {color={"#FF0033", "#040101"}})
MY_MODULE:RegisterTitle("@nogetrandom", nil, 1730, {en = "Boomer"}, {color={"#BDC3C7"}})
